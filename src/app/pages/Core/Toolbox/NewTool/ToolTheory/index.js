...
export const ToolTheory = ({action}) => {
    ...
    const {theory} = dataTool;
    const save = (e) =>{
        e.preventDefault()
        if(theory){
                    
            insertToolData({opcion: "theory",
                            id: dataCurrent?.id,
                            theory: theory
                        })
            }
                ...
                <div className="card">
                    ...
                    <div className="p-fluid p-formgrid p-grid">
                        <div className="p-field p-col-12">
                            <label htmlFor="long_description">Ingrese el texto referente a la teoría de la herramienta</label>
                            <Editor style={{height:'320px'}} value={theory} onTextChange={(e) => setDataTool({ ...dataTool, theory: e.htmlValue })}/>
                        </div>
