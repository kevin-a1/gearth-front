...
export const ToolMethod = ({dataCurrent,action}) => {
    ...
    const [dataTool,setDataTool] = useState({
        method: action==="edit"?dataCurrent?.method:"",
    });
                ...
                <div className="card">
                    ...
                    <div className="p-fluid p-formgrid p-grid">
                        <div className="p-field p-col-12">
                            <label htmlFor="long_description">Ingrese el texto referente al método de la herramienta</label>
                            <Editor style={{height:'320px'}} value={method} onTextChange={(e) => setDataTool({method: e.htmlValue })}/>
                        </div>
